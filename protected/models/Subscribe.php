...
class Subscribe extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('subscribe_email', 'required'),
			array('subscribe_email', 'length', 'max'=>200),
			array('subscribe_email', 'email'),
			array('subscribe_email', 'unique'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('subscribe_id, subscribe_email', 'safe', 'on'=>'search'),
		);
	}
