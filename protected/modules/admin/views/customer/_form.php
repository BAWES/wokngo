...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'customer_civil_id'); ?>
		<?php echo $form->textField($model,'customer_civil_id',array('size'=>42,'maxlength'=>42)); ?>
		<?php echo $form->error($model,'customer_civil_id'); ?>
	</div>
